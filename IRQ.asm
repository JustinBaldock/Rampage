...
IRQ
  STA IRQHOLD+0
  LDA #1
  STA VIC_INTERRUPT_STATUS_REGISTER  
  LDA VIC_MEMORY_CONTROL_REGISTER
  ORA #2
  STA VIC_MEMORY_CONTROL_REGISTER
  DEC SYNC
  LDA #0  ;240  ; LOW FOR A,B
  STA CIA2_TIMER_A_CURRENT_L
  LDA #240
  STA CIA2_TIMER_B_CURRENT_L
  LDA #18   ; TIMER A HIGH
  STA CIA2_TIMER_A_CURRENT_H
  LDA #52   ; TIMER B HIGH
  STA CIA2_TIMER_B_CURRENT_H
  LDA #$83
  BIT CIA2_INTERRUPT_CONTROL_STATUS ; CLEAR ANY NMI
  STA CIA2_INTERRUPT_CONTROL_STATUS
  LDA #$99  ; FORCE LOAD
  STA CIA2_TIMER_A_CTRL ; TIMERS AND
  STA CIA2_TIMER_B_CTRL ; START GOING
  LDA VIC_MEMORY_CONTROL_REGISTER
  ORA #2
  STA VIC_MEMORY_CONTROL_REGISTER
  DEC SYNC
...
THCOL
  LDA #%11111100
  STA VIC_SPRITE_MULTICOLOR ; Set sprites 0-1 = single color, sprites 2-7 = multicolor
...
STILON
  LDA XCORD,X
  CMP #>344 ; 344 ;CHECK <> SYMBOL, MIGHT BE WRONG WAY
  BCC STON  ; LESS THAN
  LDA ONTAB,X ; IGNORE IT
  AND HMSB+1  ; IF MSB SET
  BEQ STON  ; RESET POS.
  LDA #>344 ; PUT BACK ;CHECK <> SYMBOL, MIGHT BE WRONG WAY
  STA XCORD,X ; TO EDGE
  LDA HELDIR,X
  EOR #254
  STA HELDIR,X
