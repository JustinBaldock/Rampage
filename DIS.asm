...
TEXTLB    !byte >TEXT,>TEXT1,>TEXT2,>TEXT3,>TEXT4,>TEXT5,>TEXT6,>TEXT7,>TEXT8,>TEXT9,>TEXT10
TEXTHB    !byte <TEXT,<TEXT1,<TEXT2,<TEXT3,<TEXT4,<TEXT5,<TEXT6,<TEXT7,<TEXT8,<TEXT9,<TEXT10
...
RESETALL
MESPRI    !byte $2F,$2B,$35,$35,$00,$3B,$31,$37,$FE
...
PLPOINTLB !byte >PLNUM,>PLNUM1,>PLNUM2 
PLPOINTHB   !byte <PLNUM,<PLNUM1,<PLNUM2
...
SELDEFF !byte 0,12,12,13,2
    !byte 4,12,12,13,6
    !byte 8,12,12,13,10
PLAYSELE  !byte 12,12,12,12,12
    !byte 14,14,14,14,14
    !byte 15,16,17,18,19
SELBUFF !byte 0,0,0,0,0
    !byte 0,0,0,0,0
    !byte 0,0,0,0,0
TILENUM !byte 0
ENERGY    !byte 127,127,127
BLOMLB    !byte 0,64,128,192
    !byte 0,64,128,192
    !byte 0,64,128,192
    !byte 0,64,128,192
    !byte 0,64,128,192
...
SCRMLB    !byte 0,8,16,24,32
    !byte 64,72,80,88,96
    !byte 128,136,144,152,160
SCRMHB    !byte SHB+0,SHB+0,SHB+0,SHB+0,SHB+0
